...
public class ShoppingList implements Runnable {
   ...
   public final static ShoppingList shoppingListObj = new ShoppingList();
   ...
   public static DefaultListModel<String> items=null;
   //public static JTextArea chatText = null;
   public static JList<String> itemList=null;
   public static JTextField itemEntered = null;
...
//    	          if (index >= 0) {
//    	            String o = (String)itemList.getModel().getElementAt(index);
//    	            System.out.println("the element want to be deleted/clicked is at "+index);
//    	            items.remove(index);
//    	            System.out.println("clicked on: " + o);
//    	            sendString(0+o);
//    	          }
//    	          //sendString(o);
//    	        }
...
//					TODO Auto-generated method stub
					...
					if(!itemList.isSelectionEmpty()&&selectedIndex!=-1) {
						String itemDeleted=items.getElementAt(selectedIndex);
						/*SwingUtilities.invokeLater(new Runnable(){public void run(){*/
		  				    //Update the model here
//								items.removeElementAt(e.getFirstIndex());
						
								items.remove(selectedIndex);
							
							/* }}); */
						
						sendString(0+itemDeleted);
					}
...
//      chatText.setForeground(Color.blue);
      JScrollPane chatTextPane = new JScrollPane(itemList,
         JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
         JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
      itemEntered = new JTextField();
      itemEntered.setEnabled(false);
      //when entered the item
      itemEntered.addActionListener(new ActionAdapter() {
            public void actionPerformed(ActionEvent e) {
               String s = itemEntered.getText();
               
               if ((!s.equals(""))&&(!items.contains(s))) {
            	  //items.addElement(s);
                  appendToChatBox(s);
                  itemEntered.selectAll();
                  // Send the string
                  //0:remove 1: add
                  sendString(1+s);
               }
      ...
      ListPane.add(itemEntered, BorderLayout.SOUTH);
      ListPane.add(chatTextPane, BorderLayout.CENTER);
      ...
      mainFrame = new JFrame("Simple TCP ShoppingList");
   ...
   private static void changeStatusTS(int newConnectStatus, boolean noError) {
      ...
      SwingUtilities.invokeLater(shoppingListObj);
   }
   ...
   public void run() {
      ...
      case DISCONNECTED:
         ...
         itemEntered.setText(""); itemEntered.setEnabled(false);
         statusColor.setBackground(Color.red);
         break;
      ...
      items.addElement(toAppend.toString());
      ...
      while (true) {
         ...
         case CONNECTED:
            try {
               ...
               if (toSend.length() != 0) {
//            	   //case add 
////            	  /* if(toSend.charAt(0)==1) {
////            		   if(!(items.contains(toSend.substring(1)))){
////            			   items.addElement(toSend.substring(1));
////            		   }
////            	   }*/
//            	   //case remove
//            	   else if(toSend.charAt(0)==0) {
//            		   String removedItem = toSend.substring(1);
//            		   for(int i=0;i<items.size();i++) {
//            			   if(items.getElementAt(i).equals(removedItem)){
//            				   items.remove(i);
//            			   }
//            	   }
//            	   }
               ...
               if (in.ready()) {
                  ...
                  if ((s != null) &&  (s.length() != 0)) {
                     ...
                     // Otherwise, receive what text
                    	 ...
                    	 if(s.charAt(0)=='0') {
                    		 String removedItem = s.substring(1);
